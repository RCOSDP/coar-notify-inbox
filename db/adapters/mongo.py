...
class MongoAdapter(BaseDBAdapter):
    """The MongoDB backend, i.e. what this application did before the adapters existed."""

    # The _id MongoDB adds must never reach the API, so it is always projected out.
    _NO_ID = {"_id": 0}
